...
//   render() {
//     const { text, para, onRequestClose } = this.props;
//     return (
...
// }
  ...
  //   const text = title;
  //   ModalManager.open(
  //     <MyModal text={text} para={description} onRequestClose={() => true} />
  //   );
  // };
